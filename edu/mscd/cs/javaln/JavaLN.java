...
public class JavaLN extends Logger {
    ...
    public void entering(boolean b) {
        doEnter("" + b);
    }
    ...
    public void severe(Object o) {
        doObject(Level.SEVERE, o);
    }

    public void warning(Object o) {
        doObject(Level.WARNING, o);
    }

    public void info(Object o) {
        doObject(Level.INFO, o);
    }

    public void config(Object o) {
        doObject(Level.CONFIG, o);
    }

    public void fine(Object o) {
        doObject(Level.FINE, o);
    }

    public void finer(Object o) {
        doObject(Level.FINER, o);
    }

    public void finest(Object o) {
        doObject(Level.FINEST, o);
    }
    ...
    public void severe(byte b) {
        doString(Level.SEVERE, "" + b);
    }

    public void warning(byte b) {
        doString(Level.WARNING, "" + b);
    }

    public void info(byte b) {
        doString(Level.INFO, "" + b);
    }

    public void config(byte b) {
        doString(Level.CONFIG, "" + b);
    }

    public void fine(byte b) {
        doString(Level.FINE, "" + b);
    }

    public void finer(byte b) {
        doString(Level.FINER, "" + b);
    }

    public void finest(byte b) {
        doString(Level.FINEST, "" + b);
    }

    public void severe(short s) {
        doString(Level.SEVERE, "" + s);
    }

    public void warning(short s) {
        doString(Level.WARNING, "" + s);
    }

    public void info(short s) {
        doString(Level.INFO, "" + s);
    }

    public void config(short s) {
        doString(Level.CONFIG, "" + s);
    }

    public void fine(short s) {
        doString(Level.FINE, "" + s);
    }

    public void finer(short s) {
        doString(Level.FINER, "" + s);
    }

    public void finest(short s) {
        doString(Level.FINEST, "" + s);
    }

    public void severe(int i) {
        doString(Level.SEVERE, "" + i);
    }

    public void warning(int i) {
        doString(Level.WARNING, "" + i);
    }

    public void info(int i) {
        doString(Level.INFO, "" + i);
    }

    public void config(int i) {
        doString(Level.CONFIG, "" + i);
    }

    public void fine(int i) {
        doString(Level.FINE, "" + i);
    }

    public void finer(int i) {
        doString(Level.FINER, "" + i);
    }

    public void finest(int i) {
        doString(Level.FINEST, "" + i);
    }

    public void severe(long l) {
        doString(Level.SEVERE, "" + l);
    }

    public void warning(long l) {
        doString(Level.WARNING, "" + l);
    }

    public void info(long l) {
        doString(Level.INFO, "" + l);
    }

    public void config(long l) {
        doString(Level.CONFIG, "" + l);
    }

    public void fine(long l) {
        doString(Level.FINE, "" + l);
    }

    public void finer(long l) {
        doString(Level.FINER, "" + l);
    }

    public void finest(long l) {
        doString(Level.FINEST, "" + l);
    }

    public void severe(float f) {
        doString(Level.SEVERE, "" + f);
    }

    public void warning(float f) {
        doString(Level.WARNING, "" + f);
    }

    public void info(float f) {
        doString(Level.INFO, "" + f);
    }

    public void config(float f) {
        doString(Level.CONFIG, "" + f);
    }

    public void fine(float f) {
        doString(Level.FINE, "" + f);
    }

    public void finer(float f) {
        doString(Level.FINER, "" + f);
    }

    public void finest(float f) {
        doString(Level.FINEST, "" + f);
    }

    public void severe(double d) {
        doString(Level.SEVERE, "" + d);
    }

    public void warning(double d) {
        doString(Level.WARNING, "" + d);
    }

    public void info(double d) {
        doString(Level.INFO, "" + d);
    }

    public void config(double d) {
        doString(Level.CONFIG, "" + d);
    }

    public void fine(double d) {
        doString(Level.FINE, "" + d);
    }

    public void finer(double d) {
        doString(Level.FINER, "" + d);
    }

    public void finest(double d) {
        doString(Level.FINEST, "" + d);
    }
    ...
    public void severe(char c) {
        doString(Level.SEVERE, "" + c);
    }

    public void warning(char c) {
        doString(Level.WARNING, "" + c);
    }

    public void info(char c) {
        doString(Level.INFO, "" + c);
    }

    public void config(char c) {
        doString(Level.CONFIG, "" + c);
    }

    public void fine(char c) {
        doString(Level.FINE, "" + c);
    }

    public void finer(char c) {
        doString(Level.FINER, "" + c);
    }

    public void finest(char c) {
        doString(Level.FINEST, "" + c);
    }

    public void severe(Throwable t) {
        doString(Level.SEVERE, t.toString());
    }

    public void warning(Throwable t) {
        doString(Level.WARNING, t.toString());
    }

    public void info(Throwable t) {
        doString(Level.INFO, t.toString());
    }

    public void config(Throwable t) {
        doString(Level.CONFIG, t.toString());
    }

    public void fine(Throwable t) {
        doString(Level.FINE, t.toString());
    }

    public void finer(Throwable t) {
        doString(Level.FINER, t.toString());
    }

    public void finest(Throwable t) {
        doString(Level.FINEST, t.toString());
    }
